...
def OptimizeRealSchedule_conv_PSB(input_dim, output_node, int_node):
    ...
    print int_node
    x = Dense(int(int_node), activation='tanh')(input1)
    real_out = Dense(int(output_node), activation='linear')(x)
...
def OptimizeBinSchedule_conv_PSB(input_dim, output_node, int_node):
    ...
    print int_node
    x = Dense(int(int_node), activation='tanh')(input2)
    bin_out = Dense(int(output_node), activation='sigmoid')(x)
...
def CreateRealSchedule_conv_PSB(input_dim, output_dim, int_node):
    ...
    input1 = Input(shape=(input_dim,))
    x = Dense(int(int_node), activation='sigmoid')(input1)
    real_out = Dense(int(output_dim), activation='linear')(x)
...
def CreateBinSchedule_conv_PSB(input_dim, output_dim, int_node):
    ...
    input2 = Input(shape=(input_dim,))
    x = Dense(int(int_node), activation='tanh')(input2)
    bin_out = Dense(int(output_dim), activation='sigmoid')(x)
