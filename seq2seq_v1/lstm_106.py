...
#numpy.save('HVAC_normal_train.npy', H_t)
######################################
########VALIDATION DATA
#################
...
data = DataFunctions.read_PSB_csv(date_start, date_end, 5, 20) #read data at 5 min resolutions
conv_critical, crac_critical, crac_normal, conv_normal, HVAC_critical, Elev, HVAC_normal, elec_total = DataFunctions.PSB_elec_split(data) #split by end uses
H_val = DataFunctions.fix_data(crac_critical) #substract to find differences
...
#numpy.save('HVAC_normal_val.npy', H_val)
##########################################################
###Test data: 2016
...
data = DataFunctions.read_PSB_csv(date_start, date_end, 5, 20) #read data at 5 min resolutions
conv_critical, crac_critical, crac_normal, conv_normal, HVAC_critical, Elev, HVAC_normal, elec_total = DataFunctions.PSB_elec_split(data) #split by end uses
H_e = DataFunctions.fix_data(crac_critical) #substract to find differences
...
#numpy.save('HVAC_normal_test.npy', H_e)
...
def objective(params):
    ...
    optimize_model = build_lstm_v1.lstm_model_106b(params, train_data.shape[2], 24)
...
lstm_model = build_lstm_v1.lstm_model_106b(lstm_hidden, train_data.shape[2], tsteps)
...
#Saving files
numpy.save('CRAC_critical_A.npy', Y_lstm2)


#### Plotting
PlotFunctions.Plot_double(t_array, H_e, t_array, Y_lstm2, 'Actual conv power','LSTM conv power', 'k-', 'r-', "fig_HVAC2a.eps")
PlotFunctions.Plot_triple(t_train, H_t, t_test, Y_lstm2, t_test, H_e, 'Training Data', 'Model B predictions', 'Test Data (actual)', 'k-', 'r-', 'b-', "fig_HVACA2b.eps")
PlotFunctions.Plot_triple(t_train, H_t, t_test, Y_lstm, t_test, H_e, 'Training Data', 'Model B predictions', 'Test Data (actual)', 'k-', 'r-', 'b-', "fig_HVAC2c.eps")
PlotFunctions.Plot_quadruple(t_train, H_t, t_test, Y_lstm2, t_test, Y_NN, t_test, H_e, 'Training Data', 'Model B predictions', 'MLP Predictions', 'Test Data (actual)', 'k-', 'r-', 'y-', 'b-', "fig_HVACA2d.eps")
