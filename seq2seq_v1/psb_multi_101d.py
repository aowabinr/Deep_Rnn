...
H_t2 = DataFunctions.fix_10min_data(H_t2, 0.05, small_list2, large_list2)
max_unit = numpy.rint(1/0.05)
H_t2 = DataFunctions.make_10min_tensor(H_t2, max_unit, 0.05)
...
H_val2 = DataFunctions.make_10min_tensor(H_val2, max_unit, 0.05)
...
Y_e2 = H_e2.copy()
H_e2 = DataFunctions.fix_10min_data(H_e2, 0.05, small_list2, large_list2)
H_e2 = DataFunctions.make_10min_tensor(H_e2, max_unit, 0.05)
...
for attempts in range(attempt_max):
    ...
    for ep in range(epoch_max):
        ...
        if val_loss_v[count] < epsilon and loss_val < loss_old:
            ...
            Y_lstm = DataFunctions.make_realdata(Y_lstm, 0.05)
...
numpy.save('HVAC_critical_10min2DII.npy', Y_lstm)
